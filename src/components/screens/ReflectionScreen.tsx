...
---
Generated by Make·Buy·Partner Analysis Tool
Columbia Business School · Technology Strategy
    `.trim();
                    ...
                    <div className="bg-blue-50 border-l-4 border-primary rounded-r-xl p-6">
                      ...
                      <p className="text-[#1E3A5F] leading-relaxed">
                        ...
                        {analysis?.primaryRecommendation !== stance?.decision ? (
                          ...
                          <> In this case, your instinct aligned well with systematic analysis —
